...
class DoubanSpider {
    ...
    save(model, douban, detail, resolve) {
        if (detail.post.indexOf(".gif")) {
            detail.post = douban.images.medium
                ? douban.images.medium
                : douban.images.large
                    ? douban.images.large
                    : douban.images.small
                        ? douban.images.small
...
DoubanSpider.db = mongoose_1.default.createConnection(dbConstans_1.getDBAddress() + "/movies", {
